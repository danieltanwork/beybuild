...
// Server-side upload for images we generate ourselves (e.g. part icons
// cropped from an uploaded reference sheet), as opposed to createUploadUrl's
// presigned URL for the browser to upload a user-picked file directly.
